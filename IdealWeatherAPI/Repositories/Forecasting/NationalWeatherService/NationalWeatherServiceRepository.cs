...
using IdealWeatherAPI.Repositories.Forecasting.NationalWeatherService.Models.PointAlerts;
...
namespace IdealWeatherAPI.Repositories.Forecasting.NationalWeatherService
{
    public class NationalWeatherServiceRepository : IForecastingRepository
    {
        ...
        private async Task<NWSForecastResponse?> GetNWSForecast(Coordinates coordinates)
        {
            ...
            var forecastPointsResponse = await this._nwsClient.GetFromJsonAsync<NWSLocationResponse>(forecastUri);
            ...
            return await this._httpClient.GetFromJsonAsync<NWSForecastResponse>(forecastPointsResponse?.LocationFeatures?.ForecastURL);
        }
        ...
        private Task<NWSAlertResponse?> GetNWSAlert(Coordinates coordinates)
        {
            ...
            return this._nwsClient.GetFromJsonAsync<NWSAlertResponse>(alertsUri);
        }
    }
}
